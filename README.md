...
- **Students Screen**: View and add students with unique names
- **Calendar Screen**: (Coming soon) View and manage class schedule
...
- `src/screens/` - Screen components
  - `StudentsScreen.js` - Student list and add functionality 
